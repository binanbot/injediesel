      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className="w-full justify-between h-10 glass-input hover:bg-secondary/50"
          >
            {clienteSelecionado ? (
              ...
              <span className="text-muted-foreground">Selecione ou cadastre um cliente</span>
            )}
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                >
                  ...
                  <span className="text-primary font-medium">Adicionar novo cliente</span>
                </CommandItem>
              </CommandGroup>
            </CommandList>
          </Command>
